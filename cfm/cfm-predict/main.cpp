...
int main(int argc, char *argv[])
{
	...
	if (argc != 6 && argc != 2 && argc != 5 && argc != 3)
	{
		std::cout << std::endl << std::endl;
		std::cout << std::endl << "Usage: cfm-predict.exe <input_smiles_or_inchi> <prob_thresh_for_prune> <param_filename> <config_filename> <output_filename>" << std::endl << std::endl << std::endl;
